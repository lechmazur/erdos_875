...
A companion Lean~4/mathlib formalization is being prepared for public posting at \url{https://github.com/lechmazur/erdos_875/}.  The intended trusted statement is the formally checked existence of an infinite admissible set with the displayed normalized absolute-gap bound and the corresponding little-$o$ conclusion.  The Lean development should be read as the checked proof artifact once posted; this written note gives the explanatory construction, notation, and context.
...
A companion Lean~4/mathlib formalization of the main theorem is to be posted at
\url{https://github.com/lechmazur/erdos_875/}.  The intended public repository follows the same division of roles as the related Erd\H{o}s formalization repositories: the machine-checked Lean development is the trusted statement/proof artifact, and the present document supplies notation, motivation, historical context, and a human-readable proof.  The LaTeX proof above is written to keep the main invariants close to their formal counterparts: graded differences, the local carry lemma, carry-good closure, the recursive block construction, and the final gap estimate.

\medskip
\noindent\textit{Authorship, Lean proof, and verification disclosure.}
GPT-5.5 Pro is listed as first author because it produced nearly all of the mathematical derivation, proof structuring, and LaTeX drafting through prompted interaction.  Lech Mazur prompted, selected, audited, edited, curated, and is responsible for the public posting of this draft.  The mathematical claims should be checked against the Lean artifact once the repository is public.  This public draft has not been independently refereed, and neither the Lean proof nor the other checks should be regarded as journal peer review.  The literature/contextual claims should be read with the usual caveat that the cited Erd\H{o}s Problems pages are catalogues rather than complete literature reviews.
